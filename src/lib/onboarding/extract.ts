...
Rules:
- Only propose an update for a category if this turn genuinely added or changed signal about it. Most turns touch zero or one category, occasionally two. Don't force an update just to have something to say.
...
- quick_fact: only include it for categories that have quick_fact options listed above, and only if clearly stated.
