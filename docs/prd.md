...
**Structured quick facts on narrative categories.** Six of the twelve narrative categories also carry one small, closed-list structured fact alongside their AI-written summary, used for filtering — Religion & Spirituality carries **Religious affiliation**, Family carries **Wants children**, Career carries **Education level**, Relationship Goals carries **Relationship goals**, and (added during onboarding's two-step questioning build) Lifestyle carries **Social lifestyle** (Mostly homebody / Balanced / Mostly outgoing) and Social Energy carries **Social energy** (Mostly introverted / Slightly introverted / Balanced / Slightly extroverted / Mostly extroverted). The first four exist for filtering (Dealbreakers and Search need something enumerable, and a paragraph can't be queried); the latter two were added for a different reason — onboarding found that an open-ended question on a vague-feeling category ("tell me about your lifestyle") left people not knowing what to say, and a quick closed pick gives them somewhere concrete to start before the narrative follow-up. A quick fact is a coarse label, not a substitute for the narrative — "Religious affiliation: Muslim" sits next to, not instead of, "Practicing Muslim. Faith plays an important role..." Visibility follows the parent category's own toggle, same as the narrative text.
